...
export default function AboutPage() {
  return (
    <div className="flex min-h-full flex-col">
      ...
      <footer className="fixed bottom-0 right-0 w-[calc(100%-var(--sidebar-width))] bg-primary py-2 text-center text-primary-foreground group-data-[collapsible=icon]/sidebar-wrapper:w-[calc(100%-var(--sidebar-width-icon))] group-data-[side=right]/sidebar-wrapper:left-0 group-data-[side=right]/sidebar-wrapper:right-auto md:group-data-[collapsible=offcanvas]/sidebar-wrapper:w-full">
