...
export default async function MemberPage({ params }: MemberPageParams) {
  const personId = parseInt(params.person_id, 10);
...
// Generate static params for known members (optional - can be expanded)
export async function generateStaticParams() {
  // For now, return empty array - pages will be generated on-demand
  // In the future, you can pre-generate pages for current members
  return [];
}
