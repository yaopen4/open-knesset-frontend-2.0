    ...
    <DialogContent className="max-w-4xl w-[95vw] sm:w-full p-6 sm:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col space-y-4 p-6 bg-muted/50 rounded-lg">
          <h3 className="font-headline text-2xl font-semibold text-right">תרומה דרך אתר jgive.com</h3>
        ...
        <div className="flex flex-col space-y-4 p-6">
           <h3 className="font-headline text-2xl font-semibold text-right">תרומה דרך העברה בנקאית</h3>
